...
export default function EntityCard({ entity }: EntityCardProps) {
  ...
  return (
    <div className="group flex h-full flex-col rounded-[6px] bg-white border border-[#E3E5E9] p-6 hover:border-[#3F4FBF] transition-all duration-200 shadow-[0_1px_2px_rgba(30,42,58,0.05)]">
      ...
      <div className="mt-5 pt-4 border-t border-[#E3E5E9] flex items-center justify-between text-[12.5px] text-[#8A93A3] shrink-0">
